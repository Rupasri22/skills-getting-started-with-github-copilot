...
activities = {
    ...
    "Basketball Team": {
        "description": "Team-based basketball training and competitive play",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["natalie@mergington.edu", "alex@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Swimming practice and aquatic fitness activities",
        "schedule": "Wednesdays and Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
        "participants": ["logan@mergington.edu", "maya@mergington.edu"]
    },
    "Art Club": {
        "description": "Explore painting, drawing, and mixed media art",
        "schedule": "Mondays, 3:30 PM - 5:00 PM",
        "max_participants": 15,
        "participants": ["sara@mergington.edu", "luke@mergington.edu"]
    },
    "Drama Workshop": {
        "description": "Learn acting, stagecraft, and perform dramatic scenes",
